 ...
 */
public abstract class Hilt_LabelFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_LabelFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LabelFragment_GeneratedInjector) this.generatedComponent()).injectLabelFragment(UnsafeCasts.<LabelFragment>unsafeCast(this));
    }
  }
