 ...
 */
public abstract class Hilt_MilestoneFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_MilestoneFragment() {
    super();
  }

  Hilt_MilestoneFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MilestoneFragment_GeneratedInjector) this.generatedComponent()).injectMilestoneFragment(UnsafeCasts.<MilestoneFragment>unsafeCast(this));
    }
  }
