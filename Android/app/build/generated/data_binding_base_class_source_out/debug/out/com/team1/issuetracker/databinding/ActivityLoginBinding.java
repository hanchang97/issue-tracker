...
public abstract class ActivityLoginBinding extends ViewDataBinding {
  @NonNull
  public final MaterialButton btnGithubLogin;
  ...
  protected ActivityLoginBinding(Object _bindingComponent, View _root, int _localFieldCount,
      MaterialButton btnGithubLogin, MaterialButton btnGoogleLogin, View emptyView1, Button enter,
      Guideline glTitle, TextView tvTitle) {
    super(_bindingComponent, _root, _localFieldCount);
    this.btnGithubLogin = btnGithubLogin;
